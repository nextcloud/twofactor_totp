OC.L10N.register(
    ...
    "TOTP two-factor authentication disabled by the administration" : "TOTP twee-factor authenticatie uitgeschakeld door de beheerder",
    ...
    "Two-factor TOTP provider" : "Twee-factor TOTP-provider",
    "A two-factor authentication provider for TOTP (RFC 6238)" : "Een aanbieder van twee-factor authenticatie voor TOTP (RFC 6238)",
    ...
    "Could not confirm TOTP" : "TOTP kon niet worden bevestigd",
    "Enable TOTP" : "Inschakelen TOTP",
    "Your new TOTP secret is:" : "Je nieuwe TOTP geheim is:",
    "For quick setup, scan this QR code with your TOTP app:" : "Als snelle procedure, scan deze QR-code met uw TOTP-app.",
    ...
    "Verify" : "Verifiëren",
    "Get the authentication code from the two-factor authentication app on your device." : "Haal de verificatiecode op uit de app voor twee-factor authenticatie op je apparaat.",
    "Submit" : "Versturen"
},
