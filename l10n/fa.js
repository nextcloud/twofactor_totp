OC.L10N.register(
    ...
    "TOTP two-factor authentication disabled by the administration" : "احراز هویت دو عاملی TOTP توسط مدیریت غیرفعال شده است",
    ...
    "Two-factor TOTP provider" : "ارائه‌دهنده احراز هویت دو عاملی TOTP",
    "A two-factor authentication provider for TOTP (RFC 6238)" : "یک ارائه‌دهنده احراز هویت دو عاملی برای TOTP (RFC 6238)",
    "Could not enable TOTP" : "TOTP فعال نشد",
    "Could not verify your key. Please try again" : "کلید شما تأیید نشد. لطفا دوباره تلاش کنید",
    "Could not confirm TOTP" : "تأیید TOTP ممکن نشد",
