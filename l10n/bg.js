OC.L10N.register(
    ...
    "Your new TOTP secret is:" : "Вашата нова TOTP тайна е:",
    "For quick setup, scan this QR code with your TOTP app:" : "За бързо настройване, сканирайте QR кода с избрано от вас TOTP приложение:",
    "After you configured your app, enter a test code below to ensure everything works correctly:" : "След като настроите приложението, въведете генериран от него код, в полето долу, за да се уверите, че всичко работи коректно:",
