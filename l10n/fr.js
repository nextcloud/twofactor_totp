OC.L10N.register(
    ...
    "Get the authentication code from the two-factor authentication app on your device." : "Saisissez le code d'authentification de l'app d'authentification à deux facteurs sur votre appareil.",
