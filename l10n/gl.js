OC.L10N.register(
    ...
    "TOTP (Authenticator app)" : "TOTP (aplicativo de autenticación)",
    "Authenticate with a TOTP app" : "Autenticar co aplicativo TOTP",
    "Two Factor TOTP Provider" : "Provedor TOTP de dous factores",
    "TOTP two-factor provider" : "Provedor de verificación de dous factores TOTP",
    "A Two-Factor-Auth Provider for TOTP (RFC 6238)" : "Un provedor de verificación de dous pasos para TOTP (RFC 6238) ",
    "Enable TOTP" : "Activar TOTP",
    "Your new TOTP secret is:" : "O seu novo secreto de TOTP é:",
    ...
    "Get the authentication code from the two-factor authentication app on your device." : "Obteña o código de autenticación do aplicativo de autenticación de dous factores no seu dispositivo.",
    "Submit" : "Enviar"
},
